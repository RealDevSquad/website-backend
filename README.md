...
- Create a new file: `config/local.js`. Copy the contents of `config/development.js` into `config/local.js` and update the `clientId` and `clientSecret` values with your own.
